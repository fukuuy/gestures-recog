...
def resample_frames(gesture_data, target_frames=20, hands=False):
    if hands:
        gesture_data = [np.array(left + right) for left, right in gesture_data]
    ...
    if num_frames == target_frames:
        ...
        new_data = [gesture_data[int(i * step)] for i in range(target_frames)]
        return new_data
